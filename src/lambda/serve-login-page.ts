 ...
 * @returns {string} Complete HTML document with responsive design and red button
 */
...
/**
 * Lambda handler function to serve the login page via API Gateway
 * @param {APIGatewayProxyEvent} event - API Gateway proxy event
 * @returns {Promise<APIGatewayProxyResult>} API Gateway proxy result with HTML content
 */
